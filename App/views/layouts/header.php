...
<body class="bg-gray-50 min-h-screen flex flex-col font-sans" x-data="{ open: false, showLogoutModal: false }">
    <header class="bg-brand-blue border-b-2 border-[#FEDB00] shadow-xl sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 md:px-6 py-3">
            <div class="flex items-center justify-between relative">
                ...
                <div class="flex items-center justify-end gap-4 md:w-1/3" x-data="{ open: false }">
                    <div class="relative">
                        ...
                        <div x-show="open" x-cloak
                            ...
                            <button @click="showLogoutModal = true; open = false; setTimeout(() => { window.location.href = '?logoff' }, 1700)"
    ...
    <div class="relative bg-white rounded-[2.5rem] p-8 shadow-2xl w-full max-w-sm mx-4 transform transition-all animate-bounceIn border-4 border-red-500">
